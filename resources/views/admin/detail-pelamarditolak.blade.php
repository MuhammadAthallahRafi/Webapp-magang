    ...
    <div class="bg-white rounded shadow p-6">
            ...
            <div x-data="{ openMulai: false, openSelesai: false }" x-cloak class="flex flex-col sm:flex-row gap-4 mt-4">
                ...
                >
                    <div class="bg-white p-5 rounded-xl shadow-lg w-96 relative">
                        <form method="POST" action="{{ route('pelamarditolak.updateTanggalMulai', $pelamar->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="flex justify-end space-x-2 mt-4">
                                ...
                                <button type="submit"
                                    class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 text-sm font-semibold shadow-md">
                                    💾 Simpan
                                </button>
                            </div>
                        </form>
                ...
                >
                    <div class="bg-white p-5 rounded-xl shadow-lg w-96 relative">
                        <form method="POST" action="{{ route('pelamarditolak.updateTanggalSelesai', $pelamar->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="flex justify-end space-x-2 mt-4">
                                ...
                                <button type="submit"
                                    class="bg-emerald-600 text-white px-3 py-1 rounded hover:bg-emerald-700 text-sm font-semibold shadow-md">
                                    💾 Simpan
                                </button>
                            </div>
                        </form>
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button type="button"
                ...
                class="bg-orange-500 text-white px-4 py-2 rounded text-sm font-semibold hover:bg-orange-600">
                ✏️ Perbaikan
            </button>
        </div>

        {{-- Modal Terima --}}
        <div id="modal-terima-{{ $pelamar->id }}" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
        ...
        {{-- Modal Tolak --}}
        <div id="modal-tolak-{{ $pelamar->id }}" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white p-5 rounded shadow-md w-96">
        ...
        <div class="mt-6">
            ...
            class="inline-block bg-cyan-200 hover:bg-cyan-300 text-black font-semibold px-5 py-2 rounded shadow-md text-sm">
